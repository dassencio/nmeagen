...
function testLoadNmeaData() {
  const nmeaData =
    ...
    "$GPRMC,215909.285,A,5232.252,N,01321.913,E,1314.7,090.0,251216,000.0,W,A*40\n" +
    "$GPGGA,215910.285,5232.252,N,01322.513,E,1,12,1.0,0.0,M,0.0,M,,*69\n" +
    "$GPGSA,A,3,01,02,03,04,05,06,07,08,09,10,11,12,1.0,1.0,1.0*30\n" +
    "$GPRMC,215910.285,A,5232.252,N,01322.513,E,2161.5,000.0,251216,000.0,W,A*4F\n" +
    "$GPGGA,215911.285,5232.852,N,01322.513,E,1,12,1.0,0.0,M,0.0,M,,*62\n" +
    "$GPGSA,A,3,01,02,03,04,05,06,07,08,09,10,11,12,1.0,1.0,1.0*30\n" +
    "$GPRMC,215911.285,A,5232.852,N,01322.513,E,1314.4,270.0,251216,000.0,W,A*43\n" +
    "$GPGGA,215912.285,5232.852,N,01321.913,E,1,12,1.0,0.0,M,0.0,M,,*6E\n" +
    "$GPGSA,A,3,01,02,03,04,05,06,07,08,09,10,11,12,1.0,1.0,1.0*30\n" +
    "$GPRMC,215912.285,A,5232.852,N,01321.913,E,1314.4,270.0,251216,000.0,W,A*4F\n";
